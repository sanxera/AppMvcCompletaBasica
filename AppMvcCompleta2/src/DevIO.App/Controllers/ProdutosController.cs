...
namespace DevIO.App.Controllers
{
    ...
    public class ProdutosController : BaseController
    {
        ...
        {
            return View(_mapper.Map<IEnumerable<ProdutoViewModel>>(await _produtosRepository.ObterProdutosFornecedores()));
        }
        ...
        [ClaimsAuthroize("Produto", "Adicionar")]
        [Route("novo-produto")]
        ...
        [ClaimsAuthroize("Produto", "Editar")]
        ...
        public async Task<IActionResult> Edit(Guid id, ProdutoViewModel produtoViewModel)
        {
            ...
            produtoAtualizacao.Valor = produtoAtualizacao.Valor;
        ...
        [ClaimsAuthroize("Produto", "Excluir")]
